...
<head>
	...
	<title>Единая заявка | Штатная структура</title>
...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
                    ...
                    <li id="db-user-item" class=""><a href="user.php" class="db-item" id="db-user"><i class="fa fa-user"></i> <span>Пользователи</span></a></li>
                    <li id="db-ticket-item" class=""><a href="ticket.php" class="db-item" id="db-ticket"><i class="fa fa-ticket"></i> <span>Заявки</span></a></li>
                    <li id="db-staff-item" class="active"><a href="stafftree.php" class="db-item" id="db-staff"><i class="fa fa-suitcase"></i> <span>Штатная структура</span></a></li>
                    <li id="db-tree-item" class=""><a href="restree.php" class="db-item" id="db-tree"><i class="fa fa-chain"></i> <span>ИТ-ресурсы</span></a></li>
                    <li id="db-admin-item" class=""><a href="admin.php" class="db-item" id="db-tree"><i class="fa fa-unlock"></i> <span>Администраторы</span></a></li>				</ul>
			</section>
		</aside>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Штатная структура<small>Иерархическое дерево подразделений и относящихся к ним должностей</small></h1>
			</section>
	...
	<script src="../js/getstaff.js?ver=1"></script>
</body>
</html>
