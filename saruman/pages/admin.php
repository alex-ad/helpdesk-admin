...
<head>
	...
	<title>Единая заявка | Администраторы</title>
...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
                    ...
                    <li id="db-staff-item" class=""><a href="stafftree.php" class="db-item" id="db-staff"><i class="fa fa-suitcase"></i> <span>Штатная структура</span></a></li>
                    <li id="db-tree-item" class=""><a href="restree.php" class="db-item" id="db-tree"><i class="fa fa-chain"></i> <span>ИТ-ресурсы</span></a></li>
                    <li id="db-admin-item" class="active"><a href="admin.php" class="db-item" id="db-tree"><i class="fa fa-unlock"></i> <span>Администраторы</span></a></li>				</ul>
			</section>
		</aside>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Администраторы<small>Список пользователей с правами на просмотр/изменение информации</small></h1>
			</section>
	...
	<script src="../js/getadmin.js?ver=1"></script>
</body>
</html>
