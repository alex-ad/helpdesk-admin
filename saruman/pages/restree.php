...
<head>
	...
	<title>Единая заявка | ИТ-ресурсы</title>
...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
                    ...
                    <li id="db-tree-item" class="active"><a href="restree.php" class="db-item" id="db-tree"><i class="fa fa-chain"></i> <span>ИТ-ресурсы</span></a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>ИТ-ресурсы<small>Иерархическое дерево ИТ-ресурсов</small></h1>
			</section>
	...
	<script src="../js/gettree.js?ver=1"></script>
</body>
</html>
