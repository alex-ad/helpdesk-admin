...
<head>
	...
	<title>Единая заявка | Заявки</title>
...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
                    ...
                    <li id="db-ticket-item" class="active"><a href="ticket.php" class="db-item" id="db-ticket"><i class="fa fa-ticket"></i> <span>Заявки</span></a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Заявки<small>Список составленных заявок</small></h1>
			</section>
	...
	<script src="../js/getticket.js?ver=1"></script>
</body>
</html>
