...
<head>
	...
	<title>Единая заявка | Пользователи</title>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
                    ...
                    <li id="db-user-item" class="active"><a href="user.php" class="db-item" id="db-user"><i class="fa fa-user"></i> <span>Пользователи</span></a></li>
